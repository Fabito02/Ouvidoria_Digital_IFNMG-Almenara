  ...
  return (
    <div className="max-w-5xl mx-auto px-4">
      <form onSubmit={handleSubmit} className="space-y-6 mt-10 mb-5">
        <h1 className="text-4xl font-semibold mb-10">Reclamação</h1>
        ...
        <div>
          <h3 className="mb-1">Descreva sua reclamação</h3>
          <div
            id="editor"
            className="inputReclamacao border border-border bg-background quill-textarea"
          ></div>
        </div>
